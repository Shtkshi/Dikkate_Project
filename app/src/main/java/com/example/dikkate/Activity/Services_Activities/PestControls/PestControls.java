...
public class PestControls extends AppCompatActivity {
    ...
    void Slider() {
        ...
        sliderDataArrayList.add(R.drawable.pestone);
        sliderDataArrayList.add(R.drawable.pesttwo);
        sliderDataArrayList.add(R.drawable.pestthree);
        sliderDataArrayList.add(R.drawable.pestfour);
