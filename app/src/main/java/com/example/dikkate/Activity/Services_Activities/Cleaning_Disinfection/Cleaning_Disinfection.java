package com.example.dikkate.Activity.Services_Activities.Cleaning_Disinfection;
...
public class Cleaning_Disinfection extends AppCompatActivity {
    Dao dao;
    int UserId;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cleaning__disinfection);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        CollapsingToolbarLayout toolBarLayout = (CollapsingToolbarLayout) findViewById(R.id.toolbar_layout);
        toolBarLayout.setTitle("Cleaning and Disinfection");
        ...
        //Add the ite button
        Button button1 = findViewById(R.id.add_cleaning);
        button1.setBackgroundColor(Color.parseColor("#CAE1FF"));

        //Adding an item
        CardView CheckOut = (CardView) findViewById(R.id.Cart_cleaning);
        ...
        if (Cart == 0) {
            ...
            TextView NoOfOrderDisplay = findViewById(R.id.no_of_orders_cleaning);
        ...
        Feedback();
        TextView AverageStars=findViewById(R.id.Stars_average_Cleaning);
        AverageStars.setText(String.valueOf(dao.Average_Feedback(4,0)));

        TextView AverageStars2=findViewById(R.id.starAverageCleaning);
        AverageStars2.setText(String.valueOf(dao.Average_Feedback(4,0)));
    ...
    protected void onResume() {
        super.onResume();
        TextView NoOfOrders=(TextView)findViewById(R.id.no_of_orders_cleaning);
        NoOfOrders.setText(String.valueOf(dao.NoOfOrders(UserId,1)));
        if(dao.NoOfOrders(UserId,1)==0){
            CardView Cart=findViewById(R.id.Cart_cleaning);
    ...
    void CartService() {
        ...
        LinearLayout Cart = (LinearLayout) findViewById(R.id.CartLinear_cleaning);
        Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Cleaning_Disinfection.this, CartPage1.class);
    ...
    void AddServices(Button button, CardView CheckOut, Dao dao, int UserId) {
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                catergory_user_mapping.setCategoryID(4);
                ...
                TextView orderTextview = findViewById(R.id.no_of_orders_cleaning);
    ...
    void Slider() {
        ...
        SliderView sliderView = findViewById(R.id.slide_cleaning);
    ...
    private void Feedback(){
        feedbacks=dao.Feedbacks(4,0);
        RecyclerViewFeedback=(RecyclerView)findViewById(R.id.recyclefeedbackCleaning);
        RecyclerViewFeedback.setLayoutManager(new LinearLayoutManager(Cleaning_Disinfection.this,LinearLayoutManager.VERTICAL,false));
        feedbackAdapter=new FeedbackAdapter(Cleaning_Disinfection.this,feedbacks,dao);
